...
int main(int argc, char **argv){
	...
	while (!quit){
		...
		if (left)
		{
			sprite1->setVX(setMoveSpeed(walk_speed, left, right));
			spriteAction = "walk ";
			if (shift)
			{
				sprite1->setVX(setMoveSpeed(run_speed, left, right));
				spriteAction = "run ";
			}
			facing = "left";
		}
		...
		{
			sprite1->setVX(setStateSpeed(grounded_speed));
		}
		if (up && grounded)
		{
			sprite1->setVY(setStateSpeed(fall_speed));
		}
		...
		if (collide(*sprite1, *spriteBG))
		{
			...
			sprite1->setVY(setStateSpeed(grounded_speed));
			grounded = true;
		}
		...
		{
			sprite3->setVX(reflectfront[0]);
			sprite3->setVY(reflectfront[1]);
			sprite3->setAX(reflectfront[2]);
			//sprite3->setAY(-0.2);
		}

		if (sprite3->getX() <= 0)
		{
			sprite3->setVX(reflectback[0]);
			sprite3->setVY(reflectback[1]);
			sprite3->setAX(reflectback[2]);
			//sprite3->setAY(0.1);
		}

		if (sprite3->getY() <= 0)
		{
			sprite3->setVY(reflecttop[0]);
			sprite3->setAX(reflecttop[1]);
			sprite3->setAY(reflecttop[2]);
		}
